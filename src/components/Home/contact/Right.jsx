        ...
        <div className='flex flex-col justify-center'>
            ...
            <div>
                <div className='flex items-center'>
                    ...
                    <p className='text-gray-500 text-sm md:text-base'>اسم المدينه-المنطيقه-اسم الشارع-رقم المبنى</p>
                </div>
                <div className='flex items-center my-5'>
                    ...
                    <p className='text-gray-500 text-sm md:text-base'>السبت الى الخميس من 8 صباحا الى 5 مساء</p>
                </div>
                <div className='flex items-center my-5'>
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className='text-gray-500 text-sm md:text-base'>username1@gmail.com</p>
                </div>
                <div className='flex items-center my-5'>
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className='text-gray-500 text-sm md:text-base'>01223456789</p>
                </div>
            </div>
        </div>
    )
