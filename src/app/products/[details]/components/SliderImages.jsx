...
function SliderImages({images}) {
    ...
    const settings = {
        customPaging: function () {
            return (
                <div className='w-[120px] h-[120px] relative border border-[#B6B597] rounded-md'>
                    <Image blurDataURL={activeImage.placeholder} placeholder='blur' sizes="(min-width: 808px) 50vw, 100vw" src={`${activeImage.path}`} alt='image' fill/>
                </div>
            );
        },
        dots: true,
